...
using Aqt.CoreOracle.Web.HealthChecks;
...
[DependsOn(
    typeof(CoreOracleHttpApiModule),
...
public class CoreOracleWebModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                typeof(CoreOracleResource),
                typeof(CoreOracleDomainModule).Assembly,
                typeof(CoreOracleDomainSharedModule).Assembly,
                typeof(CoreOracleApplicationModule).Assembly,
                typeof(CoreOracleApplicationContractsModule).Assembly,
                typeof(CoreOracleWebModule).Assembly
            );
        });
    ...
    private void ConfigureAutoMapper()
    {
        ...
        {
            options.AddMaps<CoreOracleWebModule>();
        });
    }
    ...
    private void ConfigureVirtualFileSystem(IWebHostEnvironment hostingEnvironment)
    {
        ...
        {
            options.FileSets.AddEmbedded<CoreOracleWebModule>();
            ...
            if (hostingEnvironment.IsDevelopment())
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<CoreOracleWebModule>(hostingEnvironment.ContentRootPath);
            }
        });
    }
